...
async def segment_dicom(file: UploadFile = File(...)):
    ...
    try:
        ...
        description = hd.seg.SegmentDescription(
            segment_number=1,
            segment_label='Fracture',
            segmented_property_category=codes.SCT.Tissue,  # Adjust as needed
            segmented_property_type=codes.SCT.BoneStructure,  # Adjust as needed
            algorithm_type=hd.seg.SegmentAlgorithmTypeValues.MANUAL,
        )
        ...
        seg_obj = hd.seg.Segmentation(
            ...
            instance_number=1,
            manufacturer='Radpretation AI',
            manufacturer_model_name='Bone Fracture Segmentation Algorithm',
            software_versions='0.0.1',
            device_serial_number='1234567890'
        )
